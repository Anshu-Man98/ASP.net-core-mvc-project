...
namespace EmployeeDeactivation.Controllers
{
    ...
    public class PdfController : Controller
    {
        ...
        //[HttpPost]
        //[Route("Pdf/SavePdf")]
        //public void SavePdf(string memoryStream, string employeeName, string teamName, string gId, DateTime lastWorkingDate, string sponsorName)
        //{
        //    _pdfDataOperation.SavePdfInDatabase(memoryStream, employeeName, teamName, gId, lastWorkingDate, sponsorName);
        //}
